...
function handleQuizSubmission(event, quizId) {
    ...
    const totalQuestions = document.querySelectorAll(`#${quizId} .question`).length; // Fixed the dynamic selector
...
function getQuizAnswers(quizName) {
    const answerKey = {
        math: { math1: 'b', math2: 'a' },  // Math quiz with 2 questions
        swedish: { swedish1: 'b', swedish2: 'b', swedish3: 'a' },  // Swedish quiz with 3 questions
        english: { english1: 'b', english2: 'a', english3: 'c' }  // English quiz with 3 questions
    };
    return answerKey[quizName];
}
